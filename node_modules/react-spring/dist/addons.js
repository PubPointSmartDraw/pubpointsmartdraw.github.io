...
function (_Animation) {
  ...
  function TimingAnimation(config) {
    ...
    _this.onUpdate = function () {
      ...
      if (now$$1 >= _this._startTime + _this._duration) {
      ...
      _this._onUpdate(_this._fromValue + _this._easing((now$$1 - _this._startTime) / _this._duration) * (_this._to - _this._fromValue));
...
function (_Animation) {
  ...
  function OscillatorAnimation(config) {
    ...
    _this.onUpdate = function () {
      ...
      var deltaTime = (now$$1 - _this._lastTime) / 1000;
