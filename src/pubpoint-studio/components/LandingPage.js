      ...
      <div className="main-page-wrapper home-page-one">
  			...
  			<div className="html-top-content">
  					...
  					<div className="container">
  						<div className="menu-wrapper clearfix">
  							<ul className="button-group float-right">
  								<li><a href="#" className="tran3s" id="account-button">COMPTE</a></li>
  								<li><a href="#" className="tran3s login" id="login-button">CONNEXION</a></li>
  							</ul>

  							<div className="account-modal col-md-9 col-md-offset-2" id="account-modal">
  								<div className="col-md-8 decor-image">
  										<img src="images/capture-03.png" className="decor-cover" alt=""/>
  								</div>
  								<div className="col-md-4 account-modal-form">
  									<h5 className="text-center">Créer un compte</h5>
  									<form className="account-form">
  									  <div className="form-group">
  											<label>Adresse email</label>
  											<input type="email" className="form-control" placeholder="Votre adresse"/>
  									  </div>
  									  <div className="form-group">
  									  ...
  									  <button type="submit" className="btn btn-primary float-right margin-20">Créer</button>
  									</form>
  								</div>
  							</div>

  							<div className="login-modal col-md-9 col-md-offset-2" id="login-modal">
  								<div className="col-md-8 decor-image">
  										<img src="images/capture-03.png" className="decor-cover" alt=""/>
  								</div>
  								<div className="col-md-4 login-modal-form">
  									...
  									<form className="login-form">
  									  ...
  									  <div className="form-group">
  											<label>Mot de passe</label>
  											<input type="password" className="form-control" placeholder="Mot de passe"/>
  											<small className="text-muted"><a href="#">Mot de passe oublié ?</a></small>
  									  </div>

  									  <button type="submit" className="btn btn-primary float-right margin-20">Se connecter</button>
  									</form>
  									<div className="col-md-12 margin-none">
  										<p className="account-link float-right">Pas encore de compte ? Créer un <a href="#" className="open-account">compte</a>.</p>
  									</div>
  								</div>
  							</div>
  							...
  							<div className="camera_caption">
  								<div className="main-container">
  									<div className="container">
  										...
  										<h2 className="wow fadeInUp animated">Pour créer vos élégantes <br/>vidéos d’animations.</h2>
  										<p className="wow fadeInUp animated">+ de 500 millions de professionnels connectés chaques minutes. <br/>Un seul logiciel pour vous aider à avancer efficacement.</p>

  										<div className="image-wrapper wow fadeInUp animated" data-wow-delay="0.75s">
  											<img src="images/capture-01.png" alt=""/>
  										</div>
  									</div>
  								</div>
  							</div>
  						...
  						<div className="row">
  							...
  							<div className="col-md-4 hidden-sm col-xs-12 wow fadeInUp" data-wow-delay="0.150s">
  								<div className="single-block tran3s">
  									...
  									<p>Une fois que vous avez terminé votre vidéo, op! Elle est disponible dans votre boîte mail et vous pouvez la publier en HD sur vos réseaux sociaux!</p>
  									<a href="#" className="tran3s theme-button"><span></span> Démarrer</a>
  								</div>
  							</div>
  						</div>
  				...
  				<div className="boost-your-phone">
  					<div className="container">
  						<div className="row">
  							<div className="col-lg-6 col-xs-12 float-right  wow fadeInRight">
  								<div className="text">
  						...
  						<div className="boster-image-wrapper  wow fadeInLeft">
  		    ...
  		    <div className="two-section-wrapper">
  					...
  					<div className="testimonial-section">
  						<div className="container">
  							<div className="row">
  								<div className="col-lg-8 col-xs-12 float-right wow fadeInUp">
  							...
  							<div className="screenshot-container">
  								<div className="slider-row">
  									<div className="screenshoot-slider">
  										<div className="item"><img src="images/capture-01.png" alt=""/></div>
  										<div className="item"><img src="images/capture-02.png" alt=""/></div>
  										<div className="item"><img src="images/capture-04.png" alt=""/></div>
  									</div>
  								</div>
  							</div>
  						</div>
  					...
  					<div className="container">
  						<div className="row">
  							...
  							<div className="col-md-7 col-xs-12">
  								<form action="inc/sendemail.php" className="contact-us-form form-validation" auto-complete="off">
  									<input type="email" placeholder="Email*" name="email"/>
  									<input type="text" placeholder="Objet*" name="sub"/>
  				...
  				<div className="google-map-area" id="google-map-area">
  					...
  					<div className="footer-data-wrapper">
  						<form action="#" className="subscribe-form">
  							...
  							<div className="input-wrapper">
  								<div className="row">
  									<div className="col-md-5 col-md-6 col-xs-12">
